  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview-me active"> <a href="../users/"> <i class="fa fa-users"></i> <span>Users</span> </a> </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="box box-primary">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" style="height: 100px; width: 100px;" src="../image/avatar_2.png" alt="User Image">
            <h3 class="profile-username text-center">John Doe</h3>
            <p class="text-muted text-center">Church</p>
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>YP Church Position:</b> <a class="pull-right">Vice President</a>
              </li>
              <li class="list-group-item">
                <b>MBYA Cluster Postion:</b> <a class="pull-right">President</a>
              </li>
              <li class="list-group-item">
                <b>MBYA Postion:</b> <a class="pull-right">Secretary</a>
              </li>
            </ul>
            <a href="../users/profile.php?id=3" class="btn btn-primary btn-block"><b>View Profile</b></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="box box-primary">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" style="height: 100px; width: 100px;" src="../image/avatar_7.png" alt="User Image">
            <h3 class="profile-username text-center">John Doe</h3>
            <p class="text-muted text-center">Church</p>
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
      ...
      <div class="col-md-4">
        <div class="box box-primary">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" style="height: 100px; width: 100px;" src="../image/avatar_4.png" alt="User Image">
            <h3 class="profile-username text-center">John Doe</h3>
            <p class="text-muted text-center">Church</p>
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
