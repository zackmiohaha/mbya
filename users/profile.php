      ...
      <div class="col-md-4">
        <div class="box box-primary">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" style="height: 100px; width: 100px;" src="../image/avatar_10.png" alt="User Image">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name</label>
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="" name="" placeholder="Middlename">
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Church Position:</label>
                  <div class="col-sm-6">
                    <select name="" id="" class="form-control">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">MBYA Cluster Position:</label>
                  <div class="col-sm-6">
                    <select name="" id="" class="form-control">
                      <option value="none"> -No Position- </option>
                      <option value="President"> President </option>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">MBYA Position:</label>
                  <div class="col-sm-6">
                    <select name="" id="" class="form-control">
                      <option value="none"> -No Position- </option>
                      <option value="President"> President </option>
